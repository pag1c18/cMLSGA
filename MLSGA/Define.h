...
#define VOS_DYNAMIC_VIDEO true					///<if video should be generated for dynamic VOS problem
#define SEPARATE_WIND_WAVE_CALC false			///<if power prediction is based on Kwon and Townsin (false) or Holtrop and Mennen (true)
#define PARTLY_PREDEFINED_POPULATION true		///<if population should be sampled (true) or completely random (false)
#define TURNING_CONSTRAINT true					///<if turning constraints should be considered
#define INCLUDE_TRAVEL_SEPARATION true			///<if traffic separation schemes should be considered
...
#define DEBUG_MLSGA false								///<For debugging purposes
